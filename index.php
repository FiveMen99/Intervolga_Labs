  ...
  <section class="jumbotron text-center" id="body">
      <style>
        ...
        <div class="container">
            ...
            <div><iframe width="560" height="315" src="https://www.youtube.com/embed/sHmrecCw3Yw?start=2" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
        </div>
  </section>
    ...
    <script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
    <script src="/laba/js/ajaxpost.js"></script>
    <script src="/laba/js/ajax/authorization.js"></script>
    <script src="/laba/js/ajax/registration.js"></script>
    <script src="/laba/js/ajax/crudstudents.js"></script>
    <script src="/laba/js/ajax/crudassessments.js"></script>
    <script src="/laba/js/ajax/header.js"></script>
</body>
</html>
