...
<div class="container">
   ...
   <form action="/laba/aaa.php" method="post" class="form-signin">
  ...
  <div class="form-label-group">
    <input type="text" name="parol" class="form-control" placeholder="Password" >
  ...
  <span class="nikita">Неправильный логин или пароль!</span>
