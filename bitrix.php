...
define('APP_ID', '	local.5dea2cf2320118.89218592'); // take it from Bitrix24 after adding a new application
define('APP_SECRET_CODE', 'qtMC47fZoSQ8LIpCHr5sh5fbEPbJtnIdyczLFTxtg25FDXIlwQ'); // take it from Bitrix24 after adding a new application
define('APP_REG_URL', 'https://b24-d3w303.bitrix24.ru/'); // the same URL you should set when adding a new application in Bitrix24
